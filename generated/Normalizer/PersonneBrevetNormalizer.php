...
class PersonneBrevetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return PersonneBrevet::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && PersonneBrevet::class === $data::class;
    }
    ...
    {
        return [PersonneBrevet::class => false];
    }
}
