...
class NotificationVeilleQualiteDirigeantItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationVeilleQualiteDirigeantItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationVeilleQualiteDirigeantItem::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new NotificationVeilleQualiteDirigeantItem();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('valeur') && null !== $data->getValeur()) {
            $values = [];
            foreach ($data->getValeur() as $value) {
                $values[] = $value;
            }
            $dataArray['valeur'] = $values;
        }
    ...
    {
        return [NotificationVeilleQualiteDirigeantItem::class => false];
    }
}
