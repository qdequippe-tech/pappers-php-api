...
class NotificationEntrepriseFermetureEtablissementItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationEntrepriseFermetureEtablissementItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationEntrepriseFermetureEtablissementItem::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new NotificationEntrepriseFermetureEtablissementItem();
    ...
    {
        return [NotificationEntrepriseFermetureEtablissementItem::class => false];
    }
}
