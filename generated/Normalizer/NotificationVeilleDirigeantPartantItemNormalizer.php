...
class NotificationVeilleDirigeantPartantItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationVeilleDirigeantPartantItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationVeilleDirigeantPartantItem::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new NotificationVeilleDirigeantPartantItem();
    ...
    {
        return [NotificationVeilleDirigeantPartantItem::class => false];
    }
}
