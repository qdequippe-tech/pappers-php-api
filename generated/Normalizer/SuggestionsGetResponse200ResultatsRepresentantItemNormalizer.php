...
class SuggestionsGetResponse200ResultatsRepresentantItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return SuggestionsGetResponse200ResultatsRepresentantItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SuggestionsGetResponse200ResultatsRepresentantItem::class === $data::class;
    }
    ...
    {
        return [SuggestionsGetResponse200ResultatsRepresentantItem::class => false];
    }
}
