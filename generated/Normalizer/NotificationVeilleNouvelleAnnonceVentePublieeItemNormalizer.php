...
class NotificationVeilleNouvelleAnnonceVentePublieeItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationVeilleNouvelleAnnonceVentePublieeItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationVeilleNouvelleAnnonceVentePublieeItem::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new NotificationVeilleNouvelleAnnonceVentePublieeItem();
    ...
    {
        return [NotificationVeilleNouvelleAnnonceVentePublieeItem::class => false];
    }
}
