...
class NotificationDirigeantEntreprisesItemNouvelleAnnonceProcedureCollectivePublieeItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationDirigeantEntreprisesItemNouvelleAnnonceProcedureCollectivePublieeItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationDirigeantEntreprisesItemNouvelleAnnonceProcedureCollectivePublieeItem::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new NotificationDirigeantEntreprisesItemNouvelleAnnonceProcedureCollectivePublieeItem();
        ...
        if (\array_key_exists('type_procedure_collective', $data) && null !== $data['type_procedure_collective']) {
            $object->setTypeProcedureCollective($data['type_procedure_collective']);
            unset($data['type_procedure_collective']);
        } elseif (\array_key_exists('type_procedure_collective', $data) && null === $data['type_procedure_collective']) {
            $object->setTypeProcedureCollective(null);
            unset($data['type_procedure_collective']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('typeProcedureCollective') && null !== $data->getTypeProcedureCollective()) {
            $dataArray['type_procedure_collective'] = $data->getTypeProcedureCollective();
        }
    ...
    {
        return [NotificationDirigeantEntreprisesItemNouvelleAnnonceProcedureCollectivePublieeItem::class => false];
    }
}
