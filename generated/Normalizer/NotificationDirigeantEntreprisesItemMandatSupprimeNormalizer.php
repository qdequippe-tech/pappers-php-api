...
class NotificationDirigeantEntreprisesItemMandatSupprimeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationDirigeantEntreprisesItemMandatSupprime::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationDirigeantEntreprisesItemMandatSupprime::class === $data::class;
    }
    ...
    {
        return [NotificationDirigeantEntreprisesItemMandatSupprime::class => false];
    }
}
