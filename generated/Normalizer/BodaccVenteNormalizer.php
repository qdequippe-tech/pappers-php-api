...
class BodaccVenteNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('denominationNouveauProprietaire') && null !== $data->getDenominationNouveauProprietaire()) {
            $dataArray['denomination_nouveau_proprietaire'] = $data->getDenominationNouveauProprietaire();
        }
        if ($data->isInitialized('sirenNouveauProprietaire') && null !== $data->getSirenNouveauProprietaire()) {
            $dataArray['siren_nouveau_proprietaire'] = $data->getSirenNouveauProprietaire();
        }
        if ($data->isInitialized('denominationNouvelExploitant') && null !== $data->getDenominationNouvelExploitant()) {
            $dataArray['denomination_nouvel_exploitant'] = $data->getDenominationNouvelExploitant();
        }
