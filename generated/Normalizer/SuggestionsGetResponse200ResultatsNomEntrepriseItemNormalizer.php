...
class SuggestionsGetResponse200ResultatsNomEntrepriseItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return SuggestionsGetResponse200ResultatsNomEntrepriseItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SuggestionsGetResponse200ResultatsNomEntrepriseItem::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SuggestionsGetResponse200ResultatsNomEntrepriseItem();
    ...
    {
        return [SuggestionsGetResponse200ResultatsNomEntrepriseItem::class => false];
    }
}
