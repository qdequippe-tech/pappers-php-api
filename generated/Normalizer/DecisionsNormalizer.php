...
class DecisionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return Decisions::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && Decisions::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('dispositif', $data) && null !== $data['dispositif']) {
            $object->setDispositif($data['dispositif']);
            unset($data['dispositif']);
        } elseif (\array_key_exists('dispositif', $data) && null === $data['dispositif']) {
            $object->setDispositif(null);
        }
        ...
        if (\array_key_exists('autres_parties', $data) && null !== $data['autres_parties']) {
            ...
            foreach ($data['autres_parties'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, DecisionsAutresPartiesItem::class, 'json', $context);
            }
