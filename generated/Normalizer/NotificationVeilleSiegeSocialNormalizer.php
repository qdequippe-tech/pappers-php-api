...
class NotificationVeilleSiegeSocialNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationVeilleSiegeSocial::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationVeilleSiegeSocial::class === $data::class;
    }
    ...
    {
        return [NotificationVeilleSiegeSocial::class => false];
    }
}
