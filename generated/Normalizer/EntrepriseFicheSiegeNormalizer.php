...
class EntrepriseFicheSiegeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return EntrepriseFicheSiege::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && EntrepriseFicheSiege::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new EntrepriseFicheSiege();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('domiciliation') && null !== $data->getDomiciliation()) {
            $dataArray['domiciliation'] = null === $data->getDomiciliation() ? null : new JsonObject($this->normalizer->normalize($data->getDomiciliation(), 'json', $context));
        }
    ...
    {
        return [EntrepriseFicheSiege::class => false];
    }
}
