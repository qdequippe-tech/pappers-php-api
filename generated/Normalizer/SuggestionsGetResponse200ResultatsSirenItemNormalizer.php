...
class SuggestionsGetResponse200ResultatsSirenItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return SuggestionsGetResponse200ResultatsSirenItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SuggestionsGetResponse200ResultatsSirenItem::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SuggestionsGetResponse200ResultatsSirenItem();
    ...
    {
        return [SuggestionsGetResponse200ResultatsSirenItem::class => false];
    }
}
