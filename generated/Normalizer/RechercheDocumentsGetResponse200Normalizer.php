...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class RechercheDocumentsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return RechercheDocumentsGetResponse200::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && Qdequippe\Pappers\Api\Model\RechercheDocumentsGetResponse200::class === $data::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('resultats', $data) && null !== $data['resultats']) {
                ...
                foreach ($data['resultats'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, RechercheDocumentsGetResponse200ResultatsItem::class, 'json', $context);
                }
        ...
        {
            return [RechercheDocumentsGetResponse200::class => false];
        }
    }
} else {
    class RechercheDocumentsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
