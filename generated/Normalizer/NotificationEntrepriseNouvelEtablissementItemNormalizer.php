...
class NotificationEntrepriseNouvelEtablissementItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationEntrepriseNouvelEtablissementItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationEntrepriseNouvelEtablissementItem::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new NotificationEntrepriseNouvelEtablissementItem();
    ...
    {
        return [NotificationEntrepriseNouvelEtablissementItem::class => false];
    }
}
