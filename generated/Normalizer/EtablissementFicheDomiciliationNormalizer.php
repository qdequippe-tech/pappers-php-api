...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class EtablissementFicheDomiciliationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \is_object($data) && 'Qdequippe\\Pappers\\Api\\Model\\EtablissementFicheDomiciliation' === $data::class;
        }
        ...
        {
            return ['Qdequippe\\Pappers\\Api\\Model\\EtablissementFicheDomiciliation' => false];
        }
    }
} else {
    class EtablissementFicheDomiciliationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
