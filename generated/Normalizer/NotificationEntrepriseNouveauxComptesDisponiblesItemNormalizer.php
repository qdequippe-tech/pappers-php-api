...
class NotificationEntrepriseNouveauxComptesDisponiblesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationEntrepriseNouveauxComptesDisponiblesItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationEntrepriseNouveauxComptesDisponiblesItem::class === $data::class;
    }
    ...
    {
        return [NotificationEntrepriseNouveauxComptesDisponiblesItem::class => false];
    }
}
