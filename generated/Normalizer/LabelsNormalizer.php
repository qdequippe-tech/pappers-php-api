...
class LabelsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('nbEtablissementsConcernes') && null !== $data->getNbEtablissementsConcernes()) {
            $dataArray['nb_etablissements_concernes'] = $data->getNbEtablissementsConcernes();
        }
        foreach ($data as $key => $value_5) {
            if (preg_match('/.*/', (string) $key)) {
