...
class NotificationVeilleNouveauxComptesPubliesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return NotificationVeilleNouveauxComptesPubliesItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && NotificationVeilleNouveauxComptesPubliesItem::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new NotificationVeilleNouveauxComptesPubliesItem();
    ...
    {
        return [NotificationVeilleNouveauxComptesPubliesItem::class => false];
    }
}
