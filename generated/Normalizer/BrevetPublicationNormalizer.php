...
class BrevetPublicationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return BrevetPublication::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && BrevetPublication::class === $data::class;
    }
    ...
    {
        return [BrevetPublication::class => false];
    }
}
