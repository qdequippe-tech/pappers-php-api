...
class SuggestionsGetResponse200ResultatsNomCompletItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && 'Qdequippe\\Pappers\\Api\\Model\\SuggestionsGetResponse200ResultatsNomCompletItem' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Qdequippe\Pappers\Api\Model\SuggestionsGetResponse200ResultatsNomCompletItem();
