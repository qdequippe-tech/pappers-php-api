...
class EntrepriseFichefinancesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && 'Qdequippe\\Pappers\\Api\\Model\\EntrepriseFichefinancesItem' === $data::class;
    }
    ...
    {
        return ['Qdequippe\\Pappers\\Api\\Model\\EntrepriseFichefinancesItem' => false];
    }
}
