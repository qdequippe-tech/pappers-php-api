...
class BrevetClassificationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return BrevetClassificationsItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && BrevetClassificationsItem::class === $data::class;
    }
    ...
    {
        return [BrevetClassificationsItem::class => false];
    }
}
