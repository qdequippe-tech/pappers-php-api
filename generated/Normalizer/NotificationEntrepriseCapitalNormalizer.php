...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class NotificationEntrepriseCapitalNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return NotificationEntrepriseCapital::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && NotificationEntrepriseCapital::class === $data::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new NotificationEntrepriseCapital();
            if (\array_key_exists('valeur', $data) && \is_int($data['valeur'])) {
                $data['valeur'] = (float) $data['valeur'];
            }
            if (\array_key_exists('ancienne_valeur', $data) && \is_int($data['ancienne_valeur'])) {
                $data['ancienne_valeur'] = (float) $data['ancienne_valeur'];
            }
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('ancienneValeur') && null !== $object->getAncienneValeur()) {
                $data['ancienne_valeur'] = $object->getAncienneValeur();
            }
        ...
        {
            return [NotificationEntrepriseCapital::class => false];
        }
    }
} else {
    class NotificationEntrepriseCapitalNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
