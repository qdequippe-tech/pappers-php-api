...
class SuggestionsGetResponse200ResultatsDenominationItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return SuggestionsGetResponse200ResultatsDenominationItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SuggestionsGetResponse200ResultatsDenominationItem::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SuggestionsGetResponse200ResultatsDenominationItem();
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('mention') && null !== $data->getMention()) {
            $dataArray['mention'] = $data->getMention();
        }
    ...
    {
        return [SuggestionsGetResponse200ResultatsDenominationItem::class => false];
    }
}
