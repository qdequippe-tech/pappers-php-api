...
class ListePostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return ListePostResponse201::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && ListePostResponse201::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new ListePostResponse201();
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('notificationsAjoutees') && null !== $data->getNotificationsAjoutees()) {
            $dataArray['notifications_ajoutees'] = $data->getNotificationsAjoutees();
        }
    ...
    {
        return [ListePostResponse201::class => false];
    }
}
