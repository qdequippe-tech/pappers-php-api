...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class NotificationVeilleNouveauxComptesDisponiblesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return NotificationVeilleNouveauxComptesDisponiblesItem::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && NotificationVeilleNouveauxComptesDisponiblesItem::class === $data::class;
        }
        ...
        {
            return [NotificationVeilleNouveauxComptesDisponiblesItem::class => false];
        }
    }
} else {
    class NotificationVeilleNouveauxComptesDisponiblesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
