...
class NotificationEntrepriseSiegeSocial implements AdditionalPropertiesInterface
{
    ...
    protected $codePays;
    /**
     * Date de modification de l'adresse du siège social au format AAAA-MM-JJ.
     *
     * @var string|null
     */
    protected $date;
