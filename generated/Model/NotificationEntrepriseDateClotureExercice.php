...
class NotificationEntrepriseDateClotureExercice implements AdditionalPropertiesInterface
{
    ...
    /**
     * Date de modification de la date de clôture d'exercice au format AAAA-MM-JJ.
     *
     * @var string|null
     */
    protected $date;
