...
class NotificationDirigeantEntreprisesItemMandatSupprime implements AdditionalPropertiesInterface
{
    ...
    protected $siren;
    /**
     * Date de fin de mandat du dirigeant au format AAAA-MM-JJ.
     *
     * @var string|null
     */
    protected $date;
