...
class EtablissementRecherche implements AdditionalPropertiesInterface
{
    ...
    {
        return ['siret' => ['siret', 'getSiret', 'setSiret'], 'siretFormate' => ['siret_formate', 'getSiretFormate', 'setSiretFormate'], 'nic' => ['nic', 'getNic', 'setNic'], 'numeroVoie' => ['numero_voie', 'getNumeroVoie', 'setNumeroVoie'], 'indiceRepetition' => ['indice_repetition', 'getIndiceRepetition', 'setIndiceRepetition'], 'typeVoie' => ['type_voie', 'getTypeVoie', 'setTypeVoie'], 'libelleVoie' => ['libelle_voie', 'getLibelleVoie', 'setLibelleVoie'], 'complementAdresse' => ['complement_adresse', 'getComplementAdresse', 'setComplementAdresse'], 'adresseLigne1' => ['adresse_ligne_1', 'getAdresseLigne1', 'setAdresseLigne1'], 'adresseLigne2' => ['adresse_ligne_2', 'getAdresseLigne2', 'setAdresseLigne2'], 'codePostal' => ['code_postal', 'getCodePostal', 'setCodePostal'], 'ville' => ['ville', 'getVille', 'setVille'], 'latitude' => ['latitude', 'getLatitude', 'setLatitude'], 'longitude' => ['longitude', 'getLongitude', 'setLongitude']];
    }
}
