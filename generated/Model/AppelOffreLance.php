...
class AppelOffreLance extends \ArrayObject
{
    ...
    protected $acheteur;
    /**
     * Liste des entreprises titulaires potentielles de l’appel d’offre.
     *
     * @var list<AppelOffreEntreprise>|null
     */
    protected $titulaires;
     ...
     * Liste des entreprises titulaires potentielles de l’appel d’offre.
     *
     * @return list<AppelOffreEntreprise>|null
     */
     ...
     * Liste des entreprises titulaires potentielles de l’appel d’offre.
     *
     * @param list<AppelOffreEntreprise>|null $titulaires
     */
    public function setTitulaires(?array $titulaires): self
    {
        $this->initialized['titulaires'] = true;
