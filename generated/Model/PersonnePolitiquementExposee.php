...
class PersonnePolitiquementExposee implements AdditionalPropertiesInterface
{
    ...
    {
        return ['enCours' => ['en_cours', 'getEnCours', 'setEnCours'], 'fonctions' => ['fonctions', 'getFonctions', 'setFonctions']];
    }
}
